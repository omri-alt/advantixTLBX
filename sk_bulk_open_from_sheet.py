...
Use ``--mon-network kl|feed1|feed2|feed5|feed3|feed4|new|skip`` (default ``kl``) for the new rows.
``new`` / ``skip`` skip the hourly unmon pause probe on the exploration sheet.
